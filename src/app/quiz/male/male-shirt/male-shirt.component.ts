...
@Component({
  selector: 'app-male-shirt',
  templateUrl: './male-shirt.component.html',
  styleUrls: ['./male-shirt.component.scss']
})
export class MaleShirtComponent implements OnInit {
  ...
  goNext() {
    ...
    this.route.navigate(['quiz/male/shirt/' + nextRoute]);
